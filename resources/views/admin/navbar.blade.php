<div class="ad-header d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center gap-2 gap-md-3 w-100">
        ...
        <form action="" class="header-search-form">
            ...
            <div class="header-desktop-search">
                <input type="search" class="form-control" id="desk-search-id" placeholder="Search …"
                    title="Search for:">

                <button type="submit" class="gray-search-icon"><img src="assets/images/icons/search-gray-18.svg"
                        alt=""></button>
            </div>
            <!-- For Mobile Search -->
            ...
            <form action="">
                <div class="img-text-select">
                    <div class="selected-show">
                        ...
                        <span class="select-text">CAD</span>
                    </div>
                    <div class="drop-content">
                        <ul class="drop-ul">
                            ...
                            <li>
                                <span class="select-image">
                                    <img src="assets/images/flag-united-kingdom.svg" alt="">
                                </span>
                                <span class="select-text">GBP</span>
                            </li>
                            <li>
                                <span class="select-image">
                                    <img src="assets/images/flag-france.svg" alt="">
                                </span>
                                <span class="select-text">Euro</span>
                            </li>
                            <li>
                                <span class="select-image">
                                    <img src="assets/images/flag-germany.svg" alt="">
                                </span>
                                <span class="select-text">Euro</span>
                            </li>
                        </ul>
                ...
                <input type="hidden" id="" class="selected-text" name="" value="CAD">
            </form>
        </div>
        <!-- Notification -->
